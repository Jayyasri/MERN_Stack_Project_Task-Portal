...
const SigninAdmin = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(err).length > 0 ) {
            ...
            navigate('/admin/signinadmin/loginadmin')  
            return
        }
    ...
    return(
        <>   
            <div className="ASiginandanimationimage"> 

                <div className="wholeformASignin"> 
                ...
                <div className="animationimageAsignin"> <Lottie style={{marginLeft: 20, paddingRight: 100, width: 500, height: 500}} animationData={animationData} /> </div>
